...
namespace exercicio1 {
    class Tela {
        public static void mostrarMenu() { //função de mostrar o menu, só imprime as opções
        ...
        public static void mostrarProdutos() { //função de listar os produtos
            Console.WriteLine("LISTAGEM DE PRODUTOS:");
            for (int i = 0; i < Program.produtos.Count; i++) { //for para exibir todos os produtos, é executado até q 'i' seja igual ao tamanho da lista
